...
const Footer = () => {
  return (
    <div className=" mt-12 flex flex-col gap-4 bg-white dark:bg-slate-700 dark:text-gray-300 py-10 container mx-auto px-4 md:px-8 xl:px-16 ">
      
      <div className="flex flex-col lg:flex-row gap-4">


      <div className="flex flex-col gap-10 flex-1 ">
        <h2 className="font-bold">MASSIMO</h2>
